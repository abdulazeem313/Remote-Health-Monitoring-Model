    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
		  ...
		  <li><a href="http://localhost/SmartHospital/DHO/index.php">LogOut</a></li>
        </ul>
...
echo "<strong><p style='background-color:#d2d2d2;color:#808080';>District :". $dist."/".$sub_tal."</p></strong>";?>
 <div>
    <table width="100%" >
 ...
 $array = $con->query("select * from pat_view ");
 $i=0;
        ...
        ?>
          <tr >
            <td><?php echo $i; ?></td>
            <td>
			<form method='post' action="http://localhost/SmartHospital/search/index.php">
			...
			<td><?php echo dname1($row['did']); ?></td>
			<td><?php echo hname1($row['hid']); ?></td>
         
            
</tr>
      <?php	/*echo "<a onclick='this.form.target='_blank';return true;'class='btn btn-link btn-xs' href=http://localhost/SmartHospital/search/index.php?pid=$row[pid]>".$row['pid']; </a>*/
        }
       ?>
     </tbody>
    </table>
